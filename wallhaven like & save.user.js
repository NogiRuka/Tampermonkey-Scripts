    ...
    createApp({
      data() {
        return {
          message: "Hello Vue!",
          // 🥚彩蛋
          emoticons: ["⁄(⁄⁄•⁄ω⁄•⁄⁄)⁄", "(＊／ω＼＊)", "(▼ヘ▼#)", "(ฅωฅ*)", "(๑′ᴗ‵๑)Ｉ Lᵒᵛᵉᵧₒᵤ❤", "(•ॢ◡-ॢ)-♡", "(｀⌒´メ)", "＼(＾▽＾)／", "T^T", "༼༎ຶᴗ༎ຶ༽", "(ಥ﹏ಥ)", "٩(๑❛ᴗ❛๑)۶", "(～￣▽￣)～ ", "(◕ᴗ◕✿)", "✧*｡٩(ˊᗜˋ*)و✧*｡", "(o°ω°o)", "(〃'▽'〃)", "ー=≡Σ( ε¦) 0", "(´･ω･)ﾉ(._.`)", "(ง •_•)ง,加油", "＼(＞０＜)／　加油", "Hi~ o(*￣▽￣*)ブ", "|。•ω•)っ◆ 我喜欢你♪", "(〃￣ω￣〃）ゞ你是变态", "(σ°∀°)σ..:*☆哎哟不错哦", "(*^▽^*)", "(^_−)☆", "*✧⁺˚⁺ପ(๑･ω･)੭ु⁾⁾ 好好学习天天向上"]
        };
      },
      methods: {
        save() {
